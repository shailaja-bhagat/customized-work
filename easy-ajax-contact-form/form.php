...
//define vars
$eacf_option = get_option('eacf_option');

$to			=	$eacf_option['form']['email'];
$redirect_page_id  =	$eacf_option['form']['thanks'];
$email_subject  =	$eacf_option['form']['subject'];

$google_sitekey_local =	isset($eacf_option['go']['local_sitekey']) ? $eacf_option['go']['local_sitekey'] : '';
$google_secretkey_local =	isset($eacf_option['go']['local_secretkey']) ? $eacf_option['go']['local_secretkey'] : '';

$google_sitekey_live =	isset($eacf_option['go']['live_sitekey']) ? $eacf_option['go']['live_sitekey'] : '';
$google_secretkey_live =	isset($eacf_option['go']['live_secretkey']) ? $eacf_option['go']['live_secretkey'] : '';
...
<div class="contact_form_container">
    <div id="result"></div>
    <form name="contact_form" class="customContactForm" id="eacf_contact_form" method="post" action="<?php the_permalink(); ?>" >
    ...
    <div class="control_row col_parent">
        ...
        <div class="control_row col_parent">
            <div class="control_box w50">
                <input id="contact_form_phone" type="text" name="contact_form_phone" placeholder="Phone" maxlength = "15" class="cf_reqMsg"/>
