			...
			if ($display_type === 'slider') {
				...
				$html .= '<div class="wcapf-price-filter-wrapper">';
					...
					$html .= '<div class="slider-values">';
						$html .= '<p>' . __('Min Price', 'wcapf') . ': <span class="wcapf-slider-value" id="wcapf-noui-slider-value-min"></span><span class="wcapf-slider-value">.00</span></p>';
						$html .= '<p>' . __('Max Price', 'wcapf') . ': <span class="wcapf-slider-value" id="wcapf-noui-slider-value-max"></span><span class="wcapf-slider-value">.00</span></p>';
					$html .= '</div>';
				$html .= '</div>';
			}
