			...
			if ($sub_term_data && ($sub_term_data->parent == $parent_term_id)) {
				...
				if ($count > 0 || $force_show === true) {
					...
					if (in_array($_parent_term_id, $term_ids)) {
						...
						$html .= '<a href="javascript:void(0)" data-key="' . $data_key . '" data-value="' . $_parent_term_id . '" data-multiple-filter="' . $enable_multiple . '"  data-color="' . $parent_term->name . '"></a>';
			...
			foreach ($parent_terms as $parent_term) {
				...
				if ($count > 0 || $force_show === true) {
					...
					if (in_array($parent_term_id, $term_ids)) {
						...
						$html .= '<a href="javascript:void(0)" data-key="' . $data_key . '" data-value="' . $parent_term_id . '" data-multiple-filter="' . $enable_multiple . '" data-color="' . $parent_term->name . '"><span class="tt-square"></span></a>';
